# Refused Bequest - Ejercicio en PHP
...
**Archivo**: `BaseController.php` y `ReadOnlyController.php`
...
```bash
./vendor/bin/phpunit tests/CodeSmells/OopAbusers/RefusedBequestTest.php
```
