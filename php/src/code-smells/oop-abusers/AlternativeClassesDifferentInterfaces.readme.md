# Alternative Classes with Different Interfaces - Ejercicio en PHP
...
**Archivo**: `TextLogger.php` y `MessageWriter.php`
...
```bash
./vendor/bin/phpunit tests/CodeSmells/OopAbusers/AlternativeClassesDifferentInterfacesTest.php
```
