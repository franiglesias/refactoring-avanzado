...
[Ejercicio](dont_use_abbreviations.py)
...
[Ejercicio](one_indentation_level.py)
...
[Ejercicio](no_primitives.py)

## 5. Colecciones de primera clase

Los tipos colectivos (list, dict, set, etc.) son una forma de representar colecciones de objetos, pero al igual que ocurre con los tipos primitivos, no nos protegen de problemas de validez o integridad de las invariantes del dominio.
...
[Ejercicio](first_class_collections.py)
...
[Ejercicio](no_getters_or_setters.py)
...
[Ejercicio](not_more_than_2_instance_variables.py)
...
[Ejercicio](only_one_dot_per_line.py)
