# Alternative Classes with Different Interfaces - Ejercicio en TypeScript
...
**Archivo**: `alternative-classes-different-interfaces.ts`
...
```bash
npm test -- alternative-classes-different-interfaces.test.ts
```
