# Alternative Classes with Different Interfaces - Ejercicio en Go
...
**Archivo**: `alternative_classes_different_interfaces.go`
...
```bash
go test ./code_smells/oop_abusers/alternative_classes_different_interfaces_test.go
```
