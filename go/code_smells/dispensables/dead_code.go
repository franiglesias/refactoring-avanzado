...
// Variables constantes no utilizadas y código después de un return son ejemplos claros
// de código que no aporta nada a la ejecución.

// Ejercicio: Arregla un bug en ActiveFunction (por ejemplo, cambia el manejo de valores negativos).

// Observa cómo el código muerto cercano dificulta razonar sobre lo que realmente se ejecuta,
// lo que puede invitar a errores o a olvidar la limpieza necesaria durante el proceso de refactorización.
