# Alternative Classes with Different Interfaces - Ejercicio en C#
...
**Archivo**: `AlternativeClassesDifferentInterfaces.cs`
...
```bash
dotnet test --filter "AlternativeClassesDifferentInterfaces"
```
