...
**Archivo a refactorizar**: `ReceiptPrinter.cs`

## Ejecutar tests

```shell
dotnet test --filter "GoldenMaster"
```

## Pasos recomendados

1. Identificar fuentes de no determinismo (Random, DateTime)
