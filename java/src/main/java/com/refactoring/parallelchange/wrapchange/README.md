...
**Archivo a refactorizar**: Crear `LegacyEmailService` y `NotificationService`
...
1. Crear wrapper `EmailServiceWrapper` con la misma interfaz `sendEmail(to, subject, body)`
2. Instanciar wrapper y reemplazarlo en `NotificationService`
